        ...
        if df.empty:
            ...
            with st.form("edit_form"):
                ...
                deal_type = st.selectbox(
                    "Deal Type",
                    ["Sale", "Rent"],
                    index=["Sale", "Rent"].index(selected.get("deal_type", "Sale"))
                    if selected.get("deal_type", "Sale") in ["Sale", "Rent"] else 0
                )
                property_type = st.selectbox(
                    "Property Type",
                    ["House", "Flat", "Plot", "Shop", "Office", "Commercial"],
                    index=["House", "Flat", "Plot", "Shop", "Office", "Commercial"].index(selected.get("property_type", "House"))
                    if selected.get("property_type", "House") in ["House", "Flat", "Plot", "Shop", "Office", "Commercial"] else 0
                )
                ...
                status = st.selectbox(
                    ...
                    index=["Available", "Sold", "Rented"].index(selected.get("status", "Available"))
                    if selected.get("status", "Available") in ["Available", "Sold", "Rented"] else 0
                )
